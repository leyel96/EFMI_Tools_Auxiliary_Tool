# Step 3: _start_extracted_import and _run_extracted_import_thread 수정

with open('mesh_extractor_gui.py', 'r', encoding='utf-8') as f:
    content = f.read()

# 1. _start_extracted_import 함수 수정 - coord_system 변수 추가 및 thread에 전달
...
# 2. _run_extracted_import_thread 함수 수정 - coordinate_system 파라미터 추가 및 전달
...
print('Step 3 complete: Modified _start_extracted_import and _run_extracted_import_thread to pass coordinate_system')
